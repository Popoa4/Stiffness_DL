...
# 实验 1 ：硬度 17 留做测试
python main.py --model_type video_tf --experiment 1 --dataset_type dataset2 --learning_rate 3e-4 --batch_size 16

# 实验 2 ：CYLIND 做测试
python main.py --model_type video_tf --experiment 2 --dataset_type dataset2 --learning_rate 3e-4 --batch_size 16

# 实验 3-basic ：BASIC 做测试
python main.py --model_type video_tf --experiment 3_basic --dataset_type dataset2 --learning_rate 3e-4 --batch_size 16

# 实验 3-choco ：CHOCO 做测试
python main.py --model_type video_tf --experiment 3_choco --dataset_type dataset2 --learning_rate 3e-4 --batch_size 16
